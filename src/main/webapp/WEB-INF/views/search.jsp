...
<body>
   ...
   <%-- <c:if test="${page > block }">
               [<a href="/BOND/search?page=1">◀◀</a>]
               [<a href="/BOND/search?page=${startBlock - 1 }&search_content=${Search_content}">◀</a>]
            </c:if>
            ...
            <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
               ...
               <c:if test="${!(i == page) }">
                  [<a href="/BOND/search?page=${i }&search_content=${Search_content}">${i }</a>]
               </c:if>
            </c:forEach>
		...
		<c:if test="${page > block }">
    		<li class="page-item">
               <a class="page-link" href="/BOND/search?page=1" aria-label="Previous">
        			<span aria-hidden="true">&laquo;</span>
      			</a>
               [<a href="/BOND/search?page=${startBlock - 1 }">◀</a>]
            </c:if>
